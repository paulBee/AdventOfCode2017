...
class week4Tests {
    ...
    @Test
    fun test1() {
        assertThat(validator.isValidPassword("aa bb cc dd ee")).isTrue()
    }

    @Test
    fun test2() {
        assertThat(validator.isValidPassword("aa bb cc dd aa")).isFalse()
    }

    @Test
    fun test3() {
        assertThat(validator.isValidPassword("aa bb cc dd aaa")).isTrue()
    }

    @Test
    fun test4() {
        assertThat(validator.isValidPassword("nyot babgr babgr kqtu kqtu kzshonp ylyk psqk")).isFalse()
    }
...
""".splitNewline().map { Pair(validator.isValidPassword2(it),it) }.filter { it.first }
    ...
    @Test
    fun test5() {
        assertThat(validator.isValidPassword2("abcde fghij")).isTrue()
    }

    @Test
    fun test6() {
        assertThat(validator.isValidPassword2("abcde xyz ecdab")).isFalse()
    }

    @Test
    fun test7() {
        assertThat(validator.isValidPassword2("a ab abc abd abf abj")).isTrue()
    }

    @Test
    fun test8() {
        assertThat(validator.isValidPassword2("iiii oiii ooii oooi oooo")).isTrue()
    }

    @Test
    fun test9() {
        assertThat(validator.isValidPassword2("oiii ioii iioi iiio")).isFalse()
    }
}